            ...
            if (this.options.autoHeight) {
                ...
                $(window).afterResize(function () {
                    $el.find(".owl-stage-outer").height(
                        Math.max.apply(null, itemsHeight)
                    );
                });
    ...
    PluginMasonry.prototype = {
        ...
        build: function () {
            ...
            if ($("html").hasClass("ie10") || $("html").hasClass("ie11")) {
                var padding =
                    parseInt(
                        self.options.wrapper.children().css("padding-left")
                    ) +
                    parseInt(
                        self.options.wrapper.children().css("padding-right")
                    );
            }
                ...
                $window.on("scroll resize", function () {
                    ...
                    background.css({
                        ...
                        "background-position-x":
                            self.options.horizontalPosition,
                    });
                });
...
(function (theme, $) {
    ...
    PluginScrollable.updateBootstrapModal = function () {
        ...
        updateBoostrapModal =
            updateBoostrapModal &&
            typeof $.fn.modal.Constructor !== "undefined";
        updateBoostrapModal =
            updateBoostrapModal &&
            typeof $.fn.modal.Constructor.prototype !== "undefined";
        updateBoostrapModal =
            updateBoostrapModal &&
            typeof $.fn.modal.Constructor.prototype.enforceFocus !==
                "undefined";
    ...
    PluginSectionScroll.prototype = {
        ...
        dotsNavigation: function () {
            ...
            dotsNav.find("a[data-nav-id]").on("click touchstart", function (e) {
                ...
                setTimeout(function () {
                    self.moveTo(
                        $(".section-wrapper").eq($this.data("nav-id")).offset()
                            .top
                    );
    ...
    PluginSort.prototype = {
        ...
        build: function () {
            ...
            if ($destination.get(0)) {
                ...
                if (
                    self.$destination.parents(".sort-destination-loader").get(0)
                ) {
                    self.$loader = self.$destination.parents(
    ...
    PluginSticky.prototype = {
        ...
        events: function () {
            ...
            if (self.options.stickyStartEffectAt) {
                ...
                $window.on("scroll", function () {
                    if (
                        self.options.stickyStartEffectAt < $window.scrollTop()
                    ) {
                        self.options.wrapper.addClass("sticky-effect-active");
                        is_backing = true;
                        ...
                        self.options.wrapper.removeClass(
                            "sticky-effect-active"
                        );
                    }
                });
    ...
    $.extend(theme, {
        Nav: {
                            ...
                            self.$mainNavItem.on("click", function (e) {
                                var currentMenuItem = $(this),
                                    ...
                                    isSubMenu =
                                        ...
                                        currentMenuItem.hasClass(
                                            "dropdown-submenu"
                                        ),
                                    isBack =
                                        currentMenuItem.hasClass("back-button"),
                                    nextMenuHeightDiff =
            ...
            events: function () {
                        ...
                        if ($window.width() < 992) {
                            ...
                            var height =
                                ...
                                $html.hasClass("sticky-header-active")
                                    ? theme.StickyHeader.options
                                          .stickyHeaderContainerHeight
                                    : headerBodyHeight;
                            $(".header-body").animate(
                                {
                                    height:
                                        $(".header-nav-main nav").outerHeight(
                                            true
                                        ) +
                                        height +
                                        10,
                ...
                $header
                    ...
                    .on("click", function (e) {
                        ...
                        if (
                            ...
                            $(".header-nav-features-dropdown.show").removeClass(
                                "show"
                            );
                ...
                // Hamburguer Menu
                var $hamburguerMenuBtn = $(
                        ".hamburguer-btn:not(.side-panel-toggle)"
                    ),
                ...
                $(".hamburguer-close:not(.side-panel-toggle)").on(
                    "click",
                    function () {
                        $(
                    ...
                    if ($window.width() < 992) {
                        $header.css({
                            height:
                                ...
                                (parseInt(
                                    $(".header-body").css("border-top-width")
                                ) +
                                    parseInt(
                                        $(".header-body").css(
                                            "border-bottom-width"
        ...
        Search: {
            ...
            build: function () {
                ...
                $(".header-nav-features-search-reveal").each(function () {
                    ...
                    $el.find(".header-nav-features-search-show-icon").on(
                        "click",
                        function () {
                            $el.addClass("show");
                    ...
                    $el.find(".header-nav-features-search-hide-icon").on(
                        "click",
                        function () {
                            $el.removeClass("show");
        ...
        StickyHeader: {
            ...
            build: function () {
                ...
                if (self.options.stickyStartAtElement) {
                    var $stickyStartAtElement = $(
                        self.options.stickyStartAtElement
                    );

                    $(window).on("scroll resize", function () {
                        self.options.stickyStartAt =
                            $stickyStartAtElement.offset().top;
                    });
                ...
                if (self.options.wrapper.find(".header-top").get(0)) {
                    minHeight =
                        initialHeaderTopHeight + initialHeaderContainerHeight;
                } else {
                ...
                self.checkStickyHeader = function () {
                    ...
                    if (
                        $window.scrollTop() >=
                        parseInt(self.options.stickyStartAt)
                    ) {
                        if (activate_flag) {
                ...
                self.activateStickyHeader = function () {
                    ...
                    $("[data-sticky-header-style]").each(function () {
                        var $el = $(this),
                            ...
                            opts = theme.fn.getOptions(
                                $el.data("sticky-header-style")
                            );
                ...
                if (self.options.stickyChangeLogo) {
                    var $logoWrapper =
                            self.options.wrapper.find(".header-logo"),
                        $logo = $logoWrapper.find("img"),
                        logoWidth = $logo.attr("width"),
                        logoHeight = $logo.attr("height"),
                        logoSmallTop = parseInt(
                            $logo.attr("data-sticky-top")
                                ? $logo.attr("data-sticky-top")
                                : 0
                        ),
